...
//Ruta del sitio
	define('ROOTURL','http://localhost/LaTrenza_4DV/');
	
	//Ruta fisica de mi carpeta de trabajo, dentro del disco duro
	define('DOCROOT',$_SERVER['DOCUMENT_ROOT'].'/LaTrenza_4DV/');
...
//VARIABLES PARA LAS RUTAS MI header.php y footer.php
	define('HEADERCLIENTE',DOCROOT.'header.php');
	define('FOOTERCLIENTE',DOCROOT.'footer.php');
...
//Esta funcion especial de php permite crear y ejecutar variables de tipo sesión, guarda cookies de el usuario que inicio sesión
?>